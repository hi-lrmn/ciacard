...
canvas.GlobalFonts.registerFromPath(`node_modules/ciacard/build/structures/font/circularstd-black.otf`, "circular-std");
canvas.GlobalFonts.registerFromPath(`node_modules/ciacard/build/structures/font/notosans-jp-black.ttf`, "noto-sans-jp");
canvas.GlobalFonts.registerFromPath(`node_modules/ciacard/build/structures/font/notosans-black.ttf`, "noto-sans");
canvas.GlobalFonts.registerFromPath(`node_modules/ciacard/build/structures/font/notoemoji-bold.ttf`, "noto-emoji");
canvas.GlobalFonts.registerFromPath(`node_modules/ciacard/build/structures/font/notosans-kr-black.ttf`, "noto-sans-kr");
...
class ciacard {
    ...
    async build() {
        ...
        if (this.theme == 'classic') {
            ...
            const imageUrls = [
                "https://cdn.is-a.fun/cia/cardcia.png",
            ];
